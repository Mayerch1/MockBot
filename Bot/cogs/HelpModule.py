...
class HelpModule(discord.Cog):
        ...
        def _error_components():
            ...
            buttons = [
                ...
                discord.ui.Button(
                    style=discord.ButtonStyle.link,
                    label='Github Issue',
                    url='https://github.com/Mayerch1/MockBot/issues'
                )
            ]
            for b in buttons:
                view.add_item(b)
    ...
    async def send_help_page(self, ctx: discord.ApplicationContext, page: str='overview'):
        ...
        def get_overview_eb():
            ...
            embed.add_field(name='*Context Menu*', value='right-click a user to toggle the automock status')
        ...
        def get_help_view(current_page='overview'):
            ...
            components = [
                ...
                discord.ui.Button(
                    style=discord.ButtonStyle.link,
                    label='Invite Me',
                    url='https://discord.com/api/oauth2/authorize?client_id=734829435844558999&permissions=274878032896&scope=bot%20applications.commands',
                    row=0
                ),
                discord.ui.Button(
                    style=discord.ButtonStyle.link,
